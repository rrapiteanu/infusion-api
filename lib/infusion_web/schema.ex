defmodule InfusionWeb.Schema do
  use Absinthe.Schema

  alias InfusionWeb.Data

  import_types(Absinthe.Type.Custom)
  import_types(InfusionWeb.Schema.CommentTypes)
  import_types(InfusionWeb.Schema.ConversationTypes)
  import_types(InfusionWeb.Schema.MessageTypes)
  import_types(InfusionWeb.Schema.PostTypes)
  import_types(InfusionWeb.Schema.UserTypes)
